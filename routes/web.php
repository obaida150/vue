...
// Test-Route für E-Mail-Versand
//Route::get('/test-mail', function () {
//    try {
//        $to = env('MAIL_TEST_RECIPIENT', 'test@example.com');
//        Log::info('Sende Test-E-Mail an: ' . $to, [
//            'mail_config' => [
...
//        ]);
//
//        // Erstelle einen Beispiel-Urlaubsantrag für den Test
//        $user = User::first() ?? new User(['id' => 1, 'full_name' => 'Test User']);
//
//        $vacationRequest = new VacationRequest();
//        $vacationRequest->id = 999; // Dummy ID
//        $vacationRequest->start_date = Carbon::now()->addDays(7);
//        $vacationRequest->end_date = Carbon::now()->addDays(14);
//        $vacationRequest->days = 5;
//        $vacationRequest->notes = 'Dies ist ein Test-Urlaubsantrag';
//
//        // Sende die E-Mail
//        Mail::to($to)->send(new VacationRequestMail(
//            $vacationRequest,
//            $user,
//            collect([
//                [
//                    'employee_name' => 'Max Mustermann',
//                    'start_date' => Carbon::now()->addDays(10)->format('d.m.Y'),
//                    'end_date' => Carbon::now()->addDays(15)->format('d.m.Y')
//                ]
//            ])
//        ));
//
//        return 'Test-E-Mail gesendet an ' . $to . '. Bitte überprüfen Sie Ihre E-Mail und die Laravel-Logs.';
//    } catch (\Exception $e) {
//        Log::error('Fehler beim Senden der Test-E-Mail: ' . $e->getMessage(), [
//            'trace' => $e->getTraceAsString()
//        ]);
//        return 'Fehler beim Senden der Test-E-Mail: ' . $e->getMessage();
//    }
//});
...
// Suche nach dem Abschnitt mit den Urlaubs-Routen und stelle sicher, dass die Route für das Zurückziehen
// VOR den Routen mit Parametern wie approve/{id} und reject/{id} platziert ist
